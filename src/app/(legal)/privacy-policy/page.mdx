# Privacy Policy for Cyberpunk AI Image Generator

## Introduction

Welcome to Cyberpunk AI Image Generator, the advanced AI image generation platform designed to create stunning cyberpunk-style artwork. At Cyberpunk AI, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using Cyberpunk AI:
...
2. **Usage Details**
   ...
   - **What We Collect**: Information about how you use Cyberpunk AI, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**

   - **What We Collect**: Data regarding the devices you use to access Cyberpunk AI, such as device type, operating system, and browser type.
...
**Copyright Owner**: [cyberpunk-ai.com](http://cyberpunk-ai.com)
**Email**: [support@cyberpunk-ai.com](mailto:support@cyberpunk-ai.com)

By using Cyberpunk AI Image Generator, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
